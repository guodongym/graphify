...
- Carry upstream 0.8.21 fixes for full-update stale-node eviction, deterministic graph output, hook loop guards, punctuation-aware query matching, built-in god-node filtering, OpenCode project installs, Amp support, and `.svh` extraction.
