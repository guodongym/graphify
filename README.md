...
| Type | Extensions |
|------|-----------|
| Code (32 languages) | `.py .ts .tsx .js .jsx .mjs .ets .go .rs .java .c .cpp .h .hpp .rb .cs .kt .scala .php .swift .lua .luau .lh .zig .ps1 .ex .exs .m .mm .jl .vue .svelte .astro .groovy .gradle .dart .v .sv .sql .f .f90 .f95 .f03 .f08 .pas .pp .dpr .dpk .lpr .inc .dfm .lfm .lpk .sh .bash .json .tab .ini .sln .csproj .fsproj .vbproj .razor .cshtml` |
